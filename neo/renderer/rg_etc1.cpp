...
found_perfect_match:
   ...
   unsigned int pack_etc1_block(void* pETC1_block, unsigned int* pSrc_pixels_rgba, etc1_pack_params& pack_params)
   {
      color_quad_u8* pSrc_pixels = reinterpret_cast<color_quad_u8*>(pSrc_pixels_rgba);
